...
!-----------------------------------------------------------------------
    ...
    str = &
'$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/cesm1_0_rel_tags/cesm1_0_rel_06_clm4_0_10/models/lnd/clm/tools/mkgriddata/creategridMod.F90 $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
         'Version', len_trim(str), trim(str)), subname)

    str = '$Id: creategridMod.F90 19052 2009-10-27 16:34:04Z erik $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
