!===============================================================================
! SVN $Id: seq_infodata_mod.F90 24486 2010-08-25 21:28:04Z mvr $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_0_rel_tags/cesm1_0_rel03_drvseq3_1_35/shr/seq_infodata_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
subroutine seq_infodata_Restart( type, infodata, restart_file, mpicom)
! !USES:
    ...
    if (.not.doread) then
       ...
       if (lmaster) then
          ...
          if (loglevel > 0) write(logunit,"(3A)") subname," write rpointer file ", &
             trim(infodata%restart_pfile)
          open(unitn, file=infodata%restart_pfile, form='FORMATTED')
          write(unitn,'(a)') restart_file
          close(unitn)
          call shr_file_freeUnit( unitn )
       endif
