!===============================================================================
! SVN $Id: seq_rest_mod.F90 24486 2010-08-25 21:28:04Z mvr $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_0_rel_tags/cesm1_0_rel03_drvseq3_1_35/driver/seq_rest_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!-------------------------------------------------------------------------------
   ...
   if (iamin_CPLID) then
      ...
      if (lnd_present) then
         ...
         call seq_io_read(rest_file,gsmap,l2x_lx,'l2x_lx')
      endif
      if (ocn_present) then
         ...
         call seq_io_read(rest_file,gsmap,x2oacc_ox%data,'x2oacc_ox')
!        call seq_io_read(rest_file,      x2oacc_ox%steps_done,'x2oacc_ox_cnt')
      ...
      if (rof_present .and. ocnrof_prognostic) then
         ...
         call seq_io_read(rest_file,gsmap,r2xacc_rx%data,'r2xacc_rx')
