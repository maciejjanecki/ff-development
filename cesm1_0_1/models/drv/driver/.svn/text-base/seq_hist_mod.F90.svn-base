!===============================================================================
! SVN $Id: seq_hist_mod.F90 24486 2010-08-25 21:28:04Z mvr $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/cesm1_0_rel_tags/cesm1_0_rel03_drvseq3_1_35/driver/seq_hist_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!                              nx=atm_nx,ny=atm_ny,whead=whead,wdata=wdata,pre='i2x_ax')
         ...
         if (rof_present .and. ocnrof_prognostic) then
            call seq_cdata_setptrs(cdata_rx,gsmap=gsmap)
            call seq_io_write(hist_file,gsmap,r2xacc_rx%data,'r2xacc_rx', &
...
!                             nx=ocn_nx,ny=ocn_ny,whead=whead,wdata=wdata,pre='x2o')
            call seq_io_write(hist_file,gsmap,x2oacc_ox%data,'x2oacc_ox', &
                              nx=ocn_nx,ny=ocn_ny,whead=whead,wdata=wdata,pre='x2oacc')
!            call seq_io_write(hist_file,         x2oacc_ox%steps_done,'x2oacc_ox_cnt', &
!                                                  whead=whead,wdata=wdata)
