...
subroutine restart_setopts( nsrest, &
   cam_branch_file_in            )
!----------------------------------------------------------------------- 
...
!=========================================================================================
   ...
   subroutine cam_write_restart( cam_out, dyn_out, &
...
!#######################################################################
   ...
   subroutine cam_read_restart( cam_out, dyn_in, dyn_out, stop_ymd, stop_tod, NLFileName )
