...
!
       ...
       call mpiscatterv (tmp3d_a ,numsend, displs, mpir8,vort(1,1,beglat,1) ,numrecv, mpir8,0,mpicom)
       call mpiscatterv (tmp3d_b ,numsend, displs, mpir8,div (1,1,beglat,1) ,numrecv, mpir8,0,mpicom)
#else
