...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 12, & ! number of heterogeneous processes
                            phtcnt = 73, & ! number of photolysis reactions
                            rxntot = 232, & ! number of total reactions
                            gascnt = 159, & ! number of gas phase reactions
                            ...
                            nzcnt = 496, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 42, & ! number of species in implicit class
