...
!----------------------------------------------
      ...
      real(r8), intent(inout) :: mat(nzcnt)
         ...
         mat(364) = -( rxt(87) + rxt(91)*y(7) + rxt(92)*y(7) + rxt(94)*y(43) &
                      ...
                      + rxt(103)*y(15) + rxt(104)*y(15) + rxt(105)*y(20) )
         mat(209) = rxt(1)
         mat(490) = rxt(3)
         mat(170) = rxt(20)
         mat(205) = -( rxt(1) + rxt(2) + rxt(53) + rxt(55) + rxt(56) + rxt(57) + rxt(60) &
                      + rxt(65) + rxt(67) + rxt(68) + rxt(69) + rxt(72) )
         mat(483) = rxt(4)
         mat(425) = rxt(13)
         mat(8) = rxt(82)
         mat(5) = rxt(85) + rxt(86)
         mat(359) = rxt(92)*y(7)
         mat(7) = -( rxt(79) + rxt(82) + rxt(81)*y(51) )
         mat(4) = -( rxt(85) + rxt(86) )
         mat(480) = rxt(3)
         ...
         mat(62) = -( rxt(22) + het_rates(1) )
         mat(167) = -( rxt(19) + rxt(20) + rxt(21) )
         mat(403) = rxt(130)*y(15) + rxt(149)*y(20) + rxt(198)*y(41) + rxt(199)*y(48) &
                      + rxt(200)*y(46) + rxt(201)*y(42)
         mat(455) = -( rxt(156)*y(20) + rxt(161)*y(15) + rxt(197)*y(41) )
         ...
         mat(368) = 3.000_r8*rxt(94)*y(43) + 2.000_r8*rxt(95)*y(44) &
                      + 3.000_r8*rxt(96)*y(45) + rxt(97)*y(46)
         ...
         mat(9) = -( rxt(25) )
         mat(1) = -( rxt(26) + rxt(172) )
         mat(478) = -( rxt(28) + het_rates(8) )
         mat(456) = rxt(156)*y(20) + rxt(161)*y(15) + 2.000_r8*rxt(197)*y(41)
         mat(148) = -( rxt(27) + het_rates(10) )
         mat(157) = rxt(203) + rxt(209) + rxt(214)
         mat(158) = -( rxt(29) + rxt(30) + rxt(203) + rxt(209) + rxt(214) + het_rates(6) &
       )
         mat(14) = -( rxt(31) )
         mat(15) = rxt(31)
         mat(225) = rxt(32)
         ...
         mat(57) = rxt(35)
         mat(80) = -( het_rates(12) )
         mat(92) = -( rxt(33) + het_rates(11) )
         mat(56) = rxt(204) + rxt(212) + rxt(215)
         mat(54) = -( rxt(34) + rxt(35) + rxt(204) + rxt(212) + rxt(215) + het_rates(7) )
         mat(100) = -( rxt(228) )
