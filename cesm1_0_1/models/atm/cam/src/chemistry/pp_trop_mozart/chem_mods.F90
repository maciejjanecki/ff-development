...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 33, & ! number of heterogeneous processes
                            phtcnt = 40, & ! number of photolysis reactions
                            rxntot = 203, & ! number of total reactions
                            ...
                            nzcnt = 795, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 92, & ! number of species in implicit class
