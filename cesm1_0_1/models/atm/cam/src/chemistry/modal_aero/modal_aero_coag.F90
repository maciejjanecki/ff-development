...
! !PARAMETERS:
   ...
   real(r8), intent(in) :: wetdens_a(pcols,pver,maxd_amode) 
...
! local variables
	...
	integer :: idomode(maxd_amode), iselfcoagdone(maxd_amode)
	integer :: jfreqcoag
	integer :: k
	...
	real(r8) :: dryvol_a(pcols,pver,maxd_amode)
	...
	real(r8) :: xnumbconc(maxd_amode)
	real(r8) :: xnumbconcavg(maxd_amode), xnumbconcnew(maxd_amode)
