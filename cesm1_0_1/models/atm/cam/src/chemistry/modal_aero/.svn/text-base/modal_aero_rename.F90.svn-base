...
! local variables
   ...
   integer :: idomode(maxd_amode)
   integer, save :: lun = -1  ! logical unit for diagnostics (6, or other
                              ! if a special diagnostics file is opened)


   real (r8) :: deldryvol_a(ncol,pver,maxd_amode)
   real (r8) :: deldryvol_c(ncol,pver,maxd_amode)
   real (r8) :: deltatinv
   ...
   real (r8) :: dryvol_a(ncol,pver,maxd_amode)
   real (r8) :: dryvol_c(ncol,pver,maxd_amode)
   real (r8) :: dryvol_smallest(maxd_amode)
   real (r8) :: dum
   real (r8) :: dum3alnsg2(maxpair_renamexf)
   real (r8) :: dum_m2v, dum_m2vdt
   real (r8) :: factoraa(maxd_amode)
   real (r8) :: factoryy(maxd_amode)
   real (r8) :: frelax
   ...
   real (r8) :: v2nhirlx(maxd_amode), v2nlorlx(maxd_amode)
