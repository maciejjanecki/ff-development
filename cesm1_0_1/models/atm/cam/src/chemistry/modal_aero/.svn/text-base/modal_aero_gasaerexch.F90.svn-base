...
! !PARAMETERS:
   ...
   real(r8), intent(in)    :: dgncur_awet(pcols,pver,maxd_amode)
...
!     method_soa=2 is reversible uptake using subr modal_aero_soaexch
   ...
   integer :: idiagss
   integer :: ido_so4a(maxd_amode), ido_nh4a(maxd_amode), ido_soaa(maxd_amode)
   integer :: jac, jsrf
   integer :: k
   ...
   real (r8) :: deltatxx
   real (r8) :: dqdt_nh4(maxd_amode), dqdt_so4(maxd_amode), dqdt_soa(maxd_amode)
   real (r8) :: fac_m2v_nh4, fac_m2v_so4, fac_m2v_soa
   real (r8) :: fac_m2v_pcarbon(maxd_aspectype)
   real (r8) :: fac_volsfc_pcarbon
   real (r8) :: fgain_nh4(maxd_amode), fgain_so4(maxd_amode), fgain_soa(maxd_amode)
   real (r8) :: g0_soa
   real (r8) :: pdel_fac
   real (r8) :: qmax_nh4, qnew_nh4, qnew_so4
   real (r8) :: qold_nh4(maxd_amode), qold_so4(maxd_amode)
   real (r8) :: qold_soa(maxd_amode), qold_poa(maxd_amode)
   ...
   real (r8) :: tmp1, tmp2
   real (r8) :: uptkrate(maxd_amode,pcols,pver)  
   real (r8) :: uptkratebb(maxd_amode), uptkrate_soa(maxd_amode)  
...
!use modal_aero_data, only:  maxd_amode, ntot_amode, nspec_amode,   &
!                            lspectype_amode, lmassptr_amode,   &
!                            sigmag_amode,   &
!                            specdens_amode, specmw_amode
use modal_aero_data, only:  maxd_amode, ntot_amode,   &
                            numptr_amode,   &
                            sigmag_amode
...
implicit none
   ...
   real(r8), intent(out) :: uptkrate(maxd_amode,pcols,pver)  
                            ! gas-to-aerosol mass transfer rates (1/s)
