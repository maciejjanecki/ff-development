...
! Namelist variables
  ...
  integer            :: tgcm_ubc_ymd = 0
  integer            :: tgcm_ubc_tod = 0
...
subroutine ubc_defaultopts(tgcm_ubc_file_out, tgcm_ubc_data_type_out, tgcm_ubc_ymd_out, tgcm_ubc_tod_out, &
...
!-----------------------------------------------------------------------
   ...
   integer         , intent(out), optional :: tgcm_ubc_ymd_out
   integer         , intent(out), optional :: tgcm_ubc_tod_out
...
!-----------------------------------------------------------------------
   ...
   if ( present(tgcm_ubc_ymd_out) ) then
      tgcm_ubc_ymd_out = tgcm_ubc_ymd
   endif
   if ( present(tgcm_ubc_tod_out) ) then
      tgcm_ubc_tod_out = tgcm_ubc_tod
   endif
...
subroutine ubc_setopts(tgcm_ubc_file_in, tgcm_ubc_data_type_in, tgcm_ubc_ymd_in, tgcm_ubc_tod_in, &
...
!-----------------------------------------------------------------------
   ...
   integer         , intent(in), optional :: tgcm_ubc_ymd_in
   integer         , intent(in), optional :: tgcm_ubc_tod_in
...
!-----------------------------------------------------------------------
   ...
   if ( present(tgcm_ubc_ymd_in) ) then
      tgcm_ubc_ymd = tgcm_ubc_ymd_in
   endif
   if ( present(tgcm_ubc_tod_in) ) then
      tgcm_ubc_tod = tgcm_ubc_tod_in
   endif
...
!-----------------------------------------------------------------------
    call tgcm_ubc_inti( tgcm_ubc_file, tgcm_ubc_data_type, tgcm_ubc_ymd, tgcm_ubc_tod ) 
...
!-----------------------------------------------------------------------
    ...
    rho_top(:ncol) = pint(:ncol,ntop_molec) / (rair*msis_temp(:ncol))
    ...
    call set_tgcm_ubc( lchnk, ncol, ubc_mmr, mwdry )
