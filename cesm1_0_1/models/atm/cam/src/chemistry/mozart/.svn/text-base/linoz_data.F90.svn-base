...
!-------------------------------------------------------------------
  subroutine linoz_data_setopts(       &
    ...
    integer,          intent(in), optional :: linoz_data_ymd_in
    integer,          intent(in), optional :: linoz_data_tod_in
    ...
    if ( present(linoz_data_ymd_in) ) then
       start_ymd = linoz_data_ymd_in
    endif
    if ( present(linoz_data_tod_in) ) then
       start_tod = linoz_data_tod_in
    endif
...
!-------------------------------------------------------------------
  subroutine linoz_data_defaultopts(   &
    ...
    integer,          intent(out), optional :: linoz_data_ymd_out
    integer,          intent(out), optional :: linoz_data_tod_out
    ...
    if ( present(linoz_data_ymd_out) ) then
       linoz_data_ymd_out = start_ymd
    endif
    if ( present(linoz_data_tod_out) ) then
       linoz_data_tod_out = start_tod
    endif
...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
  subroutine linoz_data_adv( state )
