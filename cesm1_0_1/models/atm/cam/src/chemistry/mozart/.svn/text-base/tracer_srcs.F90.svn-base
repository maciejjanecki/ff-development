...
!-------------------------------------------------------------------
  subroutine tracer_srcs_setopts(       &
    ...
    integer,          intent(in), optional :: tracer_srcs_ymd_in
    integer,          intent(in), optional :: tracer_srcs_tod_in
    ...
    if ( present(tracer_srcs_ymd_in) ) then
       start_ymd = tracer_srcs_ymd_in
    endif
    if ( present(tracer_srcs_tod_in) ) then
       start_tod = tracer_srcs_tod_in
    endif
...
!-------------------------------------------------------------------
  subroutine tracer_srcs_defaultopts(   &
    ...
    integer,          intent(out), optional :: tracer_srcs_ymd_out
    integer,          intent(out), optional :: tracer_srcs_tod_out
    ...
    if ( present(tracer_srcs_ymd_out) ) then
       tracer_srcs_ymd_out = start_ymd
    endif
    if ( present(tracer_srcs_tod_out) ) then
       tracer_srcs_tod_out = start_tod
    endif
...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
  subroutine tracer_srcs_adv( state )
...
!-------------------------------------------------------------------
!-------------------------------------------------------------------
  subroutine get_srcs_data( field_name, data, ncol, lchnk  )
