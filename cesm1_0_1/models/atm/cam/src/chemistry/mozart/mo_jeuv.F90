...
!------------------------------------------------------------------------------
       integer, parameter :: neuv = 25               ! number of photolysis/ionization reactions
       integer, parameter :: nmaj = 3                ! number of major neutral species (O,O2,N2)
       integer, parameter :: nspecies = 4            ! number of neutral species(O,N,O2,N2)
