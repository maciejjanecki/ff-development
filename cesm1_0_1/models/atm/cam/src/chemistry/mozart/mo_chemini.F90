...
contains
  ...
  subroutine chemini &
    ...
    integer,          intent(in) :: ext_frc_ymd
    integer,          intent(in) :: ext_frc_tod
    character(len=*), intent(in) :: srf_emis_type
    integer,          intent(in) :: srf_emis_ymd
    integer,          intent(in) :: srf_emis_tod
    ...
    !-----------------------------------------------------------------------
    call srf_emissions_inti ( srf_emis_specifier, srf_emis_type, srf_emis_ymd, srf_emis_tod, flbc_list )
    ...
    !-----------------------------------------------------------------------
    call setext_inti()
    call extfrc_inti(ext_frc_specifier, ext_frc_type, ext_frc_ymd, ext_frc_tod )
    ...
    !-----------------------------------------------------------------------
    call sad_inti
    write(iulog,*) 'chemini: after sad_inti on node ',iam
    ...
    !-----------------------------------------------------------------------
    !	... Initialize the fixed lower boundary conditions
    !-----------------------------------------------------------------------
    call flbc_inti( flbc_file, flbc_list, flbc_timing )
    if (masterproc) write(iulog,*) 'chemini: after flbc_inti on node ',iam

    !-----------------------------------------------------------------------
    ! 	... initialize photorate module
    !-----------------------------------------------------------------------

    is_waccm = (trim(chem_name) == 'waccm_mozart') 
