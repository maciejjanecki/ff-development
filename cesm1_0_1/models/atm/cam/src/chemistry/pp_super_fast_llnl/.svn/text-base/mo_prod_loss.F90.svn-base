...
!--------------------------------------------------------------------
         ...
         loss(4) = (rxt(11)* y(2) +rxt(27)* y(13) + rxt(2) + het_rates(1))* y(4)
         ...
         loss(3) = ((rxt(24) +rxt(25))* y(2))* y(12)
         prod(3) = 0._r8
         loss(5) = (rxt(28)* y(1) +rxt(26)* y(2) +rxt(27)* y(4) + het_rates(4))* y(13)
         prod(5) = (rxt(24)*y(12) +.750_r8*rxt(25)*y(12))*y(2)
         loss(2) = 0._r8
         prod(2) = (rxt(26)*y(2) +rxt(27)*y(4) +rxt(28)*y(1))*y(13)
         loss(6) = (rxt(30)* y(1) +rxt(29)* y(2))* y(15)
         prod(6) = 0._r8
