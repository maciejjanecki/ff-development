...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 4, & ! number of heterogeneous processes
                            phtcnt = 6, & ! number of photolysis reactions
                            rxntot = 30, & ! number of total reactions
                            gascnt = 24, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 15, & ! number of "gas phase" species
                            nfs = 5, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 83, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 14, & ! number of species in implicit class
