...
! Initialize the clock
   ...
   tm_clock = ESMF_ClockCreate("CAM-ICE Time-manager clock", step_size, start_date, &
...
!-----------------------------------------------------------------------------------------
   ...
   write(iulog,*)' ********** CAM-CSIM Time Manager Configuration **********'
...
!
   ...
   if ( (get_curr_calday < 1.0) .or. (get_curr_calday > 366.0) )then
      write(iulog,*) 'ice ',sub,'calday = ', get_curr_calday
