...
!========================================================================
!
   subroutine swap_comm_defaultopts(swap_comm_protocol_out, &
...
!========================================================================
!
   subroutine swap_comm_setopts(swap_comm_protocol_in, &
                                swap_comm_maxreq_in )
!----------------------------------------------------------------------- 
...
!========================================================================
!
   subroutine fc_gather_defaultopts( fc_gather_flow_cntl_out )
!----------------------------------------------------------------------- 
! Purpose: Return default runtime options
! Author: P. Worley (modelled after Tom Henderson's code)
!-----------------------------------------------------------------------
!------------------------------Arguments--------------------------------
   ...
   !  >= 0: use point-to-point with handshaking messages and 
   !       preposting receive requests up to 
   !       min(max(1,fc_gather_flow_cntl),max_gather_block_size) ahead
...
!========================================================================
!
   subroutine fc_gather_setopts( fc_gather_flow_cntl_in )
!----------------------------------------------------------------------- 
! Purpose: Set runtime options
! Author: P. Worley (modelled after Tom Henderson's code)
!-----------------------------------------------------------------------
