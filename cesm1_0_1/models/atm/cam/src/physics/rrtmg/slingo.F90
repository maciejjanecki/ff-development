...
real(r8) :: wavmax(nswbands) = &  ! Max wavelength (micro-meters) of interval
   ...
   if (oldliqwp) then
     ...
     cliqwp(1:pcols,1:pver) =  pbuf(i_iclwp)%fld_ptr(1,1:pcols,1:pver,lchnk,1)
   endif
