  ...
  call pbuf_add('SH_FLXPRC', 'physpkg', 1, pverp, 1, sh_flxprc_idx)  ! shallow interface gbm flux_convective_cloud_rain (kg/m2/s)
  ...
  subroutine convect_shallow_tend( ztodt  , qpert   , pblht    , &
                                   cmfmc  , cmfmc2  , precc    , &
                                   qc     , qc2     , rliq     , rliq2    , & 
