...
#if ( defined SPMD )
   use spmd_dyn,     only: proc, block_buf_nrecs, chunk_buf_nrecs, &
                           local_dp_map
   use mpishorthand
#endif
...
!========================================================================
  ...
  subroutine phys_grid_init( )
    ...
    call print_memusage('phys_grid_init: start')
    ...
    call print_memusage('phys_grid_init: after allocate 1')
    clat_d = 100000.0_r8
    clon_d = 100000.0_r8
    ...
    call print_memusage('phys_grid_init: after allocate 2')
    ...
    call print_memusage('phys_grid_init: after allocate 3')
    ...
    area_d = 0.0_r8
    wght_d = 0.0_r8
    call print_memusage('phys_grid_init: after allocate 4')
    ...
    call t_adj_detailf(+2)
    call print_memusage('phys_grid_init: end')
    return
