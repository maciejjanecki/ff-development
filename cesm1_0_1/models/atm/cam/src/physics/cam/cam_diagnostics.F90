...
subroutine diag_init
  ...
  ! Declare the history fields for which this module contains outfld calls.
   ...
   if ( history_budget ) then
      call add_default ('PHIS    '  , history_budget_histfile_num, 'I')
      call add_default ('PS      '  , history_budget_histfile_num, 'I')
      call add_default ('T       '  , history_budget_histfile_num, 'I')
      call add_default ('U       '  , history_budget_histfile_num, 'I')
      call add_default ('V       '  , history_budget_histfile_num, 'I')
      call add_default (cnst_name(1), history_budget_histfile_num, 'I')
      ! State before physics (FV)
      call add_default ('TBP     '  , history_budget_histfile_num, 'I')
      call add_default (bpcnst(1)   , history_budget_histfile_num, 'I')
      ! State after physics (FV)
      call add_default ('TAP     '  , history_budget_histfile_num, 'I')
      call add_default ('UAP     '  , history_budget_histfile_num, 'I')
      call add_default ('VAP     '  , history_budget_histfile_num, 'I')
      call add_default (apcnst(1)   , history_budget_histfile_num, 'I')
      if ( dycore_is('LR') ) then
...
!#######################################################################
   ...
   subroutine diag_phys_tend_writeout (state, tend, ztodt, tmp_q, tmp_cldliq, tmp_cldice, &
