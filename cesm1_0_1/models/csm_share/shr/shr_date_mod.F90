...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/branch_tags/cesm1_0_rel_tags/cesm1_0_rel03_share3_100802/shr/shr_date_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
type(shr_date) function shr_date_initYMD(y,m,d,ns,sec)
...
type(shr_date) function shr_date_initCDate(cDate,ns,sec)
