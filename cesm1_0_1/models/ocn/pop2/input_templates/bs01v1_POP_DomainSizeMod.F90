...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal = 1000 ,&! extent of horizontal axis in i direction
      POP_nyGlobal = 640 ,&! extent of horizontal axis in j direction
      POP_km = 33          ,&! number of vertical levels
