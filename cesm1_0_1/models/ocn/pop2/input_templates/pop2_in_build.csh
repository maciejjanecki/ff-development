...
set slvl_data_inc       = 1.e20
set slvl_interp_freq    = never
set slvl_interp_type    = nearest
set slvl_interp_inc     = 1.e20
set slvl_filename       = unknown-slvl
...
if ( ${OCN_GRID} =~ bs01* ) then
   ...
   set slvl_interp_inc     = 1.e20
   set slvl_filename       = /scratch/lustre/plgjjakacki/LD/cesm_input_data/ocn/pop/bs01v1/forcing/SSH
   set slvl_file_fmt       = bin
...
cat >> $POP2BLDSCRIPT << EOF2
&forcing_slvl_nml
   slvl_data_type      = '$slvl_data_type'
   slvl_data_inc       = $slvl_data_inc
   slvl_interp_freq    = '$slvl_interp_freq'
   slvl_interp_type    = '$slvl_interp_type'
   slvl_interp_inc     = $slvl_interp_inc
   slvl_filename       = '$slvl_filename'
...
# only default values and for grid bs2v1
  ...
  set pt_mask     = .false.
  set pt_mask_file = unknown-pt_interior_mask_file
...
&forcing_pt_interior_nml
   ...
   pt_interior_mask              = $pt_mask
   pt_interior_mask_file         = '$pt_mask_file'
   pt_interior_mask_file_fmt     = '$pt_mask_file_fmt'
/
...
#--------------------------------------------------------------------------
  ...
  set s_mask     = .false.
  set s_mask_file = unknown-pt_interior_mask_file
...
&forcing_s_interior_nml
   ...
   s_interior_mask              = $s_mask
   s_interior_mask_file         = '$s_mask_file'
   s_interior_mask_file_fmt     = '$s_mask_file_fmt'
/
