MODULE ecosys_parms
  ...
  real(kind=r8), parameter ::      &
      ...
      PCrefDiaz  = 3.1_r8  * dps,  & !mj
      diaz_mort  = 0.17_r8 * dps,  & !diaz mort rate (1/sec)
!      diaz_kPO4  = 0.01_r8,      & !mj
      diaz_kPO4  = 0.05_r8,      & !mj zmienione 4 lipca 2013
...
!mj 27.cze.2013   diaz_temp_thres   = 10.0_r8,  & !Temp. where diaz conc thres drops
!mj 4.lip.2013      diaz_temp_thres   = 14.0_r8,  & !Temp. where diaz conc thres drops
      diaz_temp_thres   = 12.0_r8,  & !Temp. where diaz conc thres drops
...
!   parm_sp_kNO3        = 0.25_r8 !mj
    parm_sp_kNO3        = 0.15_r8 !mj  zmienione 24.cze.2013
    parm_diat_kNO3      = 0.5_r8 !mj

!   parm_sp_kNH4        = 0.25_r8 !mj same as NO3
    parm_sp_kNH4        = 0.15_r8 !mj zmienione 24.cze.2013
    parm_diat_kNH4      = 0.5_r8 !mj

    parm_sp_kFe         = 0.03e-3_r8
    parm_diat_kFe       = 0.08e-3_r8
    parm_diat_kSiO3     = 0.25_r8

!   parm_sp_kPO4        = 0.05_r8 !mj
!   parm_sp_kPO4        = 0.02_r8 !mj zmienione 24.cze.2013
!   parm_sp_kPO4        = 0.01_r8 !mj zmienione 27.cze.2013
    parm_sp_kPO4        = 0.05_r8 !mj zmienione 4.lip.2013
    parm_diat_kPO4      = 0.1_r8 !mj
